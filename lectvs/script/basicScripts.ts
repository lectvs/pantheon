namespace S {
    ...
    export function tweenPt(duration: OrFactory<number>, pt: Pt, start: Vector2, end: Vector2, easingFunction: Tween.Easing.Function = Tween.Easing.Linear): Script.Function {
        let startx = start.x;
        let starty = start.y;
        let endx = end.x;
        let endy = end.y;
